...
<?php
    ...
    foreach($telefones as $telefone){
        ...
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, $urlAPI.'enviar-mensagem');
        ...
        echo 'Parâmetro de resposta para o telefone ' . $telefone . ': ' . $response['message']."\n";        
    }
?>
    </textarea>
    <br>
    <a href="<?php echo $urlBase; ?>" class="btn btn-success">Fazer Novo Envio</a>
</div>
